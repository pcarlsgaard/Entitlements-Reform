...
- The opening fiscal adjustment equals the opening required-revenue rate minus CBO's unrounded 17.541%-of-GDP 2026 current-law revenue baseline; compact labels may round it to 17.5%, and must describe the gap as achievable through revenue, other spending reductions, or both.
